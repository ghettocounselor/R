...
# MATRICES CREATED AS PART OF HOMEWORK - mimic the process in Section 4 data

FreeThrows <- rbind(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT, CarmeloAnthony_FT, DwightHoward_FT, ChrisBosh_FT, ChrisPaul_FT, KevinDurant_FT, DerrickRose_FT, DwayneWade_FT)
#here we are removing the names in the vectors because we'll use other vectors for the rows or column titles
...
#here we are removing the names in the vectors because we'll use other vectors for the rows or column titles
rm(KobeBryant_FT, JoeJohnson_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, LeBronJames_FTA, ChrisPaul_FTA, DerrickRose_FTA, DwayneWade_FTA, KevinDurant_FTA)
