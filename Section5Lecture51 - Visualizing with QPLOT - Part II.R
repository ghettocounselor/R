...
# 'I' is for asethetics and relates to how you want to show the graphics in the plot
# use it when you are not passing some element of the dataframe to an element/parameter
...
# 1. Shapes --- search google with R shapes
qplot(data = merged, x=Internet.users, y=Birth.rate,
      colour=Region, size=I(2), shape=I(17)) 
# 2. Transparency
qplot(data = merged, x=Internet.users, y=Birth.rate,
      colour=Region, size=I(2), shape=I(17),
      alpha=I(0.6)) # 1 = fully opaque & 0 = fully transparent
# 3. Title
qplot(data = merged, x=Internet.users, y=Birth.rate,
      colour=Region, size=I(2), shape=I(17),
